...
wikis = [
    ...
    # ---------------------------------------------------------------
    ("alopex", r"^http://alopex\.li/.*$"),   # this is ok for a single wiki
    ("nicemullet", r"^https?://nm.alopex\.li/.*$"),
...
class FarmConfig(multiconfig.DefaultConfig):
    ...
    superuser = [u"SimonHeath", ]

    # IMPORTANT: grant yourself admin rights! replace YourName with
    # your user name. See HelpOnAccessControlLists for more help.
    # All acl_rights_xxx options must use unicode [Unicode]
    acl_rights_before = u"SimonHeath:read,write,delete,revert,admin"
